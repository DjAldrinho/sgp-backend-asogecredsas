...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'payment_ways' => [
            'required' => 'Selecciona al menos un medio de pago',
        ],
        'picture' => [
            'max' => 'La imagen de perfil no debe pesar más de :max kilobytes.',
        ]
    ],
    ...
    */
    ...
    'attributes' => [
        'delivery_radius' => 'Alcance',
        'delivery_min' => 'Pedido mínimo',
        'code' => 'Código',
        'phone' => 'Teléfono',
        'payment' => 'Forma de pago',
        'picture' => 'Imagen',
        'new_email' => 'Correo electrónico',
        'new_indicative' => 'Indicativo',
        'new_phone' => 'Teléfono',
        'gender' => 'Género',
