...
class TypeTransactionController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['message' => 'Successfully created Type Transaction!', 'type' => $type], 201);
    ...
    public function update(Request $request, TypeTransaction $typeTransaction)
    {
        ...
        try {
            ...
            return response()->json(['message' => 'Type Transaction Updated!', 'type' => $typeTransaction], 200);
    ...
    public function destroy(TypeTransaction $typeTransaction)
    {
        try {
            ...
            return response()->json(['message' => 'Type Transaction deleted!'], 200);
        } catch (\Exception $exception) {
